...
class PopupNotifier(QWidget):
    ...
    def show_popup(self, parent: QWidget, title='Notification', message='', 
                   position="bottom-right", delay=5000, buttons=True, ok_slot:object=None):
       ...
       # 8) Start countdown & show
        ...
        if not ok_slot:
            ...
            self.timer_button.setText('Discard')
            self.remaining_time = 0
            self.timer_button.clicked.connect(ok_slot)
        self.show()
    ...
    '''def stop_timer(self):
        ...
        self.timer_button.style().polish(self)
    ...
    def Notify(parent: QWidget, title='Notifier', message: str = '', position='bottom-right', delay=5000,
               buttons = True, ok_slot:object=None):
        
        popup = PopupNotifier()

        popup.show_popup(parent, title, message, position, delay,buttons=buttons, ok_slot=ok_slot)
