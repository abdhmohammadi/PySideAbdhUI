...
class AbdhWindow(QMainWindow):
    ...
    def initUI(self,app_title:str='PySideAbdhUI Application', 
               direction=Qt.LayoutDirection.LeftToRight, logo:QPixmap=None):
        ...
        # Custom title bar
        self.titlebar = self.__create_titlebar(self.windowTitle(), logo)
    ...
    def __create_titlebar(self,title_text,title_logo:QPixmap):
        ...
        if title_logo :
            ...
            pixmap = QPixmap(title_logo).scaled(self.logo_size, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
