...
/* ******** Text Direction (RTL/LTR) *********/
    ...
    function splitTextBlock(block, page, content)
    {
        ...
        newBlock.setAttribute("data-id", generateId());
        newBlock.setAttribute("data-type", block.getAttribute("data-type") || "Paragraph");
        ...
        if (textContainer.className) newContainer.className = textContainer.className;
        if (textContainer.getAttribute("style")) {
            newContainer.setAttribute("style", textContainer.getAttribute("style"));
        }
        if (textContainer.getAttribute("dir")) {
            newContainer.setAttribute("dir", textContainer.getAttribute("dir"));
        }
    ...
    function splitListBlock(block, page)
    {
        ...
        // attributes like class, start, type, reversed.
        var newList = document.createElement(list.tagName);
        if (list.className) newList.className = list.className;
        if (list.getAttribute("start")) newList.setAttribute("start", list.getAttribute("start"));
        if (list.getAttribute("type")) newList.setAttribute("type", list.getAttribute("type"));
        if (list.hasAttribute("reversed")) newList.setAttribute("reversed", "reversed");
    ...
    function splitGenericBlock(block, page)
    {
        ...
        // Clone the content element's tag + attributes
        var newContentEl = document.createElement(contentEl.tagName);
        if (contentEl.className) newContentEl.className = contentEl.className;
        if (contentEl.getAttribute("style")) {
            newContentEl.setAttribute("style", contentEl.getAttribute("style"));
        }
    ...
    function splitTableBlock(block, page)
    {
        ...
        newBlock.className = "block";
        newBlock.setAttribute("data-id", generateId());
        newBlock.setAttribute("data-type", "Table");

        var newTable = document.createElement("table");
        if (table.className) newTable.className = table.className;
